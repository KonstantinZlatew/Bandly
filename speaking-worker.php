...
/**
 * Fetch the next pending speaking job with a row-level lock.
 *
 * @param PDO $pdo Database connection.
 * @return array|null Job data or null if none pending.
 */
...
/**
 * Call the speaking AI evaluation service.
 *
...
/**
 * Update speaking job status in the database.
 *
 * @param PDO         $pdo    Database connection.
 * @param integer     $jobId  Submission ID.
 * @param string      $status New status value.
 * @param array|null  $result Analysis result data.
...
/**
 * Run the main speaking worker loop.
 *
 * @return void
 */
