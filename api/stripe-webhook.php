 ...
 * @return void
 */
function handleCheckoutSessionCompleted(object $session)
{
    $pdo = null;
    try {
        // #region agent log
 ...
 * @return void
 */
function handleSubscriptionUpdate(object $subscription)
{
 ...
 * @return void
 */
function handleSubscriptionDeleted(object $subscription)
{
    try {
        $pdo = db();
